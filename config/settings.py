"""
Django settings for TikTok Video Orchestrator.
"""
import os
...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="tiktok_orchestrator"),
        "USER": config("DB_USER", default="tiktok_user"),
...
CELERY_TASK_TIME_LIMIT = 60 * 5  # 5 minutes hard limit per task
